...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_universal(
    _______  , _______  , _______  , _______  , _______  , _______  ,                                         _______  , _______  , _______  , _______  , KC_F7  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  ,                                         KC_LEFT  , KC_DOWN  , KC_UP, KC_RGHT  , KC_QUOT  , KC_F12  ,
